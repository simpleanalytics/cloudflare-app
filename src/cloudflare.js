/* Simple Analytics - Privacy friendly analytics (docs.simpleanalytics.com/script; 2022-09-07; 8394; v10) */
/* eslint-env browser */
...
(function (
  ...
  window,
  {
    ...
    collectDnt:
      typeof INSTALL_OPTIONS.collect_dnt === "boolean"
        ? INSTALL_OPTIONS.collect_dnt
        : null,
    mode: INSTALL_OPTIONS.hash_mode ? "hash" : "normal",
    strictUtm:
      INSTALL_OPTIONS.advanced_settings_toggle && INSTALL_OPTIONS.strict_utm,
    allowParams:
      INSTALL_OPTIONS.advanced_settings_toggle &&
      INSTALL_OPTIONS.allow_url_parameters,
    nonUniqueHostnames:
      INSTALL_OPTIONS.advanced_settings_toggle &&
      INSTALL_OPTIONS.non_unique_hostnames,
    ignorePages:
      INSTALL_OPTIONS.advanced_settings_toggle && INSTALL_OPTIONS.ignore_pages,
    namespace: INSTALL_OPTIONS.overwrite_namespace && INSTALL_OPTIONS.namespace,
  },
